...
tabPanel(title = "4. Visualization",
         ...
         sidebarLayout(
           ...
           mainPanel(width = 9,
                     ...
                     fluidRow(
                       column(width = 6, selectInput(inputId = "I_RESULT_TABLE_GMCS_SINGLE_DOUBLE",
                                                     label = "Select which results to show:", 
                                                     choices =  list("Single KO", "Double KO (only)", "Double KO + single KOs"), 
                                                     selected = "Single KO")
                       ),
                       column(width = 6, radioButtons(inputId = "I_RESULT_TABLE_GMCS_MODE", 
                     ...
                     div(id = "mp4_heatmap",
                         ...
                         fluidRow(
                           column(width = 2, checkboxInput(inputId = "I_include_boxplots_heatmap",
                                                           label = "Include boxplots of expression in heatmap?", value = TRUE)),
                           column(width = 2, numericInput(inputId = "I_show_boxplots_hline", 
                                        label = h5("Value for horizontal line in boxplots (override by localT2)"), 
                                        value = 1)),
                           column(width = 2, checkboxInput(inputId = "I_show_SYMBOL_heatmap",
